...
local POTIONS = {
	...
	[7620] = {empty = 7636, splash = 47, mana = {150, 250}}, -- mana potion
	[7589] = {empty = 7634, splash = 47, mana = {350, 440}, level = 80, vocations = {1, 2, 3, 5, 6, 7}, vocStr = "sorcerers, druids and paladins"}, -- strong mana potion
	[7590] = {empty = 7635, splash = 47, mana = {500, 600}, level = 130, vocations = {1, 2, 5, 6}, vocStr = "sorcerers and druids"}, -- great mana potion

	[8472] = {empty = 7635, splash = 43, health = {350, 450}, mana = {170, 240}, level = 80, vocations = {3, 7}, vocStr = "paladins"} -- great spirit potion
}
