...
kasapos = {x=1030, y=1010, z=9, stackpos=255}
getkasa = getThingfromPos(kasapos)
winpos = {x=1030, y=1010, z=9}
...
doPlayerSendTextMessage(cid,22,"Lost 5 Crystal Coins.")
end
if rand == 2 then
doRemoveItem(getkasa.uid,5)
...
doSendMagicEffect(kasapos,2)
doPlayerSendTextMessage(cid,22,"Lost 10 Crystal Coins.")
end
if rand == 2 then
doRemoveItem(getkasa.uid,10)
...
doSendMagicEffect(kasapos,2)
doPlayerSendTextMessage(cid,22,"Lost 25 Crystal Coins.")
end
if rand == 2 then
doRemoveItem(getkasa.uid,25)
...
doSendMagicEffect(kasapos,2)
doPlayerSendTextMessage(cid,22,"Lost 50 Crystal Coins.")
end
if rand == 2 then
doRemoveItem(getkasa.uid,50)
...
doPlayerSendTextMessage(cid,22,"Place 5, 10, 25 or 50 Crystal Coins to enter the machine.")
end
