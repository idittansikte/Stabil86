...
local c = {
	...
	anniStor	= 9000, -- if repeatt "yes" your free Storage Nr., may be the same as lever uniqueid!
	level		= 100, -- player level
	tempAid		= 33222, -- your free nr - temp storage for magic doors and tile, IMPORTANT !anniStor ~= tempAid! - must be different
	...
	exhaustion	= 4, -- sek.
	exhaustionStor = 22333, -- your Storage Nr. for Exhaustion 
	entry = {
		{x = 1702, y = 1046, z = 8}, -- The first position just behind switch!
		{x = 1702, y = 1047, z = 8},
		{x = 1702, y = 1048, z = 8},
		{x = 1702, y = 1049, z = 8}
	},
