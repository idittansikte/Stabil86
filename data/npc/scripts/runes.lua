...
shopModule:addBuyableItem({'mana potion'}, 7620, 200, 1, 'mana potion')
shopModule:addBuyableItem({'strong health'}, 7588, 1000, 1, 'strong health potion')
shopModule:addBuyableItem({'strong mana'}, 7589, 1000, 1, 'strong mana potion')
shopModule:addBuyableItem({'great health'}, 7591, 2000, 1, 'great health potion')
shopModule:addBuyableItem({'great mana'}, 7590, 2000, 1, 'great mana potion')
shopModule:addBuyableItem({'great spirit'}, 8472, 2000, 1, 'great spirit potion')
shopModule:addBuyableItem({'ultimate health'}, 8473, 5000, 1, 'ultimate health potion')
...
shopModule:addBuyableItem({'magic wall'}, 2293, 1000, 1, 'magic wall rune')
shopModule:addBuyableItem({'paralyze'}, 2278, 30000, 1, 'paralyze rune')
...
shopModule:addBuyableItem({'wild growth'}, 2269, 4000, 1, 'wild growth rune')

shopModule:addBuyableItem({'energy wall'}, 2280, 1000, 1, 'Recovery Rune')
...
shopModule:addBuyableItem({'destroy field'}, 2261, 1000, 1, 'destroy field rune')
...
shopModule:addBuyableItem({'fire field'}, 2301, 1000, 1, 'fire field rune')
...
shopModule:addBuyableItem({'sudden death'}, 2268, 2000, 1, 'sudden death rune')
